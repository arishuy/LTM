<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%String error = (String)request.getAttribute("error-info"); %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
      ...
      <div class="body-content">
        ...
        <div class="account-content">
          <div class="account-info">
            ...
            <form action="AccountServlet?mode=change" method="post">
            <div class="table-data">
                ...
                <tr style="display:none;">
                		<td>ID</td>
                		<td>
                			<input name="id" type="text" value="<%=user.getId() %>" readonly>
                		</td>
                	</tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input name="password-old" type="password" value="<%=user.getPassword() %>" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input name="password-new" type="password" value="" >
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <% if (error != null){ %>
            <h5 style="width: 100%; text-align:center; color: red;"><%=error %></h5>
            <%} %>
        </div>
      </div>
     </div>
