      ...
      <div class="body-content">
        ...
        <div class="account-content">
          <div class="account-info">
            ...
            <form action="ManagerServlet?action=updateProduct&id=<%=pd.getId() %>" method="post">
                <table border="0">
                    <tr>
                        <td>
                            Tên sản phẩm:
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="price" value="<%=NumberFormat.getCurrencyInstance().format(pd.getPrice()) %>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="amount" value="<%=pd.getAmount() %>" />
                        </td>
                    </tr>
                </table>
