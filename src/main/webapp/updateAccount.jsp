      ...
      <div class="body-content">
        ...
        <div class="account-content">
          <div class="account-info">
            ...
            <form action="AccountServlet?mode=update" method="post">
            <div class="table-data">
                ...
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="username" type="text" value="<%=user.getUsername() %>" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="role">
								<option value="admin" <%if(user.getRole().equals("admin")){ %>selected<%} %>>Admin</option>
								<option value="user" <%if(user.getRole().equals("user")){ %>selected<%} %>>User</option>
							</select>
                        </td>
                    </tr>
                    <tr>
